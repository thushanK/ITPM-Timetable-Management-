...
import {getAllGroups , getAllRooms, addRoomsToGroups} from '../../controllers/Suitable.Controller'

class RoomsForSubGroup extends React.Component {
    ...
    loadData = (first) => {
      ...
      .then( results => {
         if(first){
          ...
          this.setState({
             groups : results.data ,
             selected_lec : results.data.length > 0 ? results.data[0].subgroup_ID : {} , 
    ...
    onFormSubmit = (e) => {
      ...
      let groups = this.state.groups.find( item => item.subgroup_ID == this.state.selected_lec )
      ...
      addRoomsToGroups(data).then( result => {
          if(result.status == 200 ){
              Config.setToast('Rooms for the Group Added Successfully!');
              this.loadData(false);
          }else{
      ...
      formValueChange = (e) => {
          ...
          let groups = this.state.groups.find( item => item.subgroup_ID == e.target.value )
                  ...
                  <div className="row" >
                          ...
                          <div className="row mt-1 pb-3" >
                              <div className="col-md-6 mt-2 mb-1" >
                                  <FormSelect 
                                      ...
                                      name="groups"
                                      error_meesage={'*Sub-Group is required'}
                                  />
                              </div>
                              <div className="col-md-6 mt-2 mb-1" >
                                  <FormSelect
                      ...
                      <table class="table borderless customtable mt-2">
                          <thead>
                              ...
                              <th className="font-08 text-dark2 ">subgroup ID</th>
   ...
   renderGroups = () => {
       console.log("these are groups ", this.state.groups);
