...
class EditWorkingDays extends React.Component {
        ...
        timeChange = (e) => {
            ...
            this.setState({
                [e.target.name]: e.target.value, errors: {...this.state.errors, time: result } });
        }
        ...
        render() {
                ...
                return ( <
                    ...
                    span className = "text-muted small" > You can edit working days groups < /span></h
                    6 >
                    <
                    /div>
...

                    {
                        ...
                        /> <
                        /div> <
                        div className = "col-md-12 mt-1 mb-1" > {!this.state.loading &&
                            <
                            MultiFormSelect
                            label = { 'Working Days' }
                            error = { errors.days }
                            ...
                            <
                            button type = "submit"
                            className = "btn-outline-info mt-2 btn btn-sm px-2 " > Update Working Days < /button> <
                            /div> <
                            /div> <
                            /form>  <
                            /div>} <
                    ...
                    Loading = () => ( <
                        ...
                        role = "status" >
                        <
                        /div><h6 className="px-2 font-08">Loading Details..</h
                        6 >
                        <
                        /div> <
                        /div>
